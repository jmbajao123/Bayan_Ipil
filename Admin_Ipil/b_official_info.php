...
<head>
  ...
  <title>Barangay Official Information &mdash; Barangay Information System</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Barangay Official Information</div>
            </div>
          </div>
              ...
              <div class="col-12 col-lg-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                  	<div class="col-lg-6">
                  		<h2>Barangay Official Information</h2>
                  	</div>
                  </div>
                  <div class="card-body">
                  	<?php
...
if (isset($_GET['b_officials_id'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $profile = !empty($row['profile']) ? "officials/" . htmlspecialchars($row['profile']) : "officials/default.png";
    }
}
?>
...
<form method="post" action="">
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-12">
                <a href="b_o.php" class="btn btn-outline-secondary">Back</a>
            </div>
        </div>
    </div>
</form>
