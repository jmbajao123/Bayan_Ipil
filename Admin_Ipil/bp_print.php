...
<head>
    ...
    <title>Barangay Position - Sibugay Tech Government Portal</title>
    <style>
        body {
...
<br><br><br>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div id="reports-container" class="card-body">
                    <center> 
                        <h6 class="m-0 font-weight-bold text-primary">Barangay Position Report</h6>
                        <div class="card-body">
    ...
    <tbody>
        ...
        // Fetch data from b_positions table
        $sql = "SELECT b_positions_id, position_name, status FROM b_positions";
    ...
    <script>
        function printAndSave() {
            ...
            var options = {
                margin: 10,
                filename: 'Barangay_Positions.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
