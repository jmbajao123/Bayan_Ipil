...
<head>
  ...
  <title>Denied Request List &mdash; Barangay Information System</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Denied Request List</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item">Denied Request List</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Denied Request List</h2>
            <div class="row">
