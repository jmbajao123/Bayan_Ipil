...
<head>
  ...
  <title>Pending Request List &mdash; Barangay Information System</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Pending Request List</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Pending Request List</h2>
            <div class="row">
        ...
        <table class="table table-bordered table-md">
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="req.php" method="POST">
                                    <input type="hidden" name="rc_id" value="<?= $row['rc_id']; ?>">
                                    <button type="submit" name="status" class="btn btn-outline-success" value="Approved">Approved</button>
                                    <button type="submit" name="status" class="btn btn-outline-danger" value="Denied">Denied</button>
                                </form>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="5">
                        	<center>No Pending requests found</center>
                        </td>
                    </tr>
                <?php endif; ?>
