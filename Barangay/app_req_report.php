...
<head>
  ...
  <title>Approved Request List Report &mdash; Barangay Information System</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Approved Request List Report</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item">Approved Request List Report</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Approved Request List Report</h2>
            <div class="row">
              <div class="col-12  col-lg-12">
                <div class="card">
                  <div class="card-header">
						    <div class="col-lg-12 d-flex justify-content-end">
						    	<a href="a_req_print.php" class="btn btn-outline-primary" target="_blank">Generate</a>
						    </div>
						</div>
                    <div class="card-body">
