...
<head>
  ...
  <title>Household List Report &mdash; Barangay Information System</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Household List Report</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="dashboard.php">Dashboard</a></div>
              <div class="breadcrumb-item">Household List Report</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Household List Report</h2>
            <div class="row">
...
<div class="card-header">
    <div class="col-lg-12 d-flex justify-content-end">
        <a href="r_h_print.php" class="btn btn-outline-primary" target="_blank">Generate</a>
    </div>
</div>
